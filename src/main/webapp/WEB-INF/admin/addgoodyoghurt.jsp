...
<div class="layui-fluid">
    <form class="layui-form layui-form-pane" action="<%=basePath%>admin/addGoodYoghurt" method="post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">毫升：</label>
            <div class="layui-input-block">
                <input type="text" name="weight" lay-verify="required" autocomplete="off" placeholder="请输入毫升" class="layui-input">
            </div>
        </div>
