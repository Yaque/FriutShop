...
<div class="layui-fluid">
    <form class="layui-form layui-form-pane" action="<%=basePath%>admin/addGoodPackingBox" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="capacity" lay-verify="required" autocomplete="off" placeholder="请输入型号" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">是否可回收：</label>
            <div class="layui-input-block">
                <input type="text" name="recycle" lay-verify="required" autocomplete="off" placeholder="请输入0或1" class="layui-input">
            </div>
        </div>
